...
module.exports = function(app) {
  ...
  // 豆瓣音乐分类录入页路由
  app
    .route('/admin/music/musicCategory/new')
  ...
  // 音乐热门榜单路由
  app
    .route('/admin/music/programme/list')
